...
namespace CopySDK.Authentication
{
    ...
    public class OAuth
    {
        ...
        /// <remarks>
        ///   <para>
        ///     To use this method, first instantiate a new Oauth.OAuth object,
        ...
        /// </returns>
        public OAuthSession AcquireRequestToken(string uri, string method)
        {
            NewRequest();
            ...
            using (var response = (System.Net.HttpWebResponse)request.GetResponse())
            {
                ...
                {
                    var r = new OAuthSession(reader.ReadToEnd());
        ...
        ///   poauth_token=foo&something_else=bar.
        /// </returns>
        public OAuthSession AcquireAccessToken(string uri, string method, string pin)
        {
            NewRequest();
